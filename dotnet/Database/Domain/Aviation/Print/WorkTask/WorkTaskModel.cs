...
namespace Allors.Database.Domain.Print.WorkTaskModel
{
    ...
    public class WorkTaskModel
    {
        public WorkTaskModel(WorkTask workTask)
        {
            ...
            this.FixedPrice = workTask.ExistMaintenanceAgreement? workTask.MaintenanceAgreement.FixedPrice.ToString("N2", new CultureInfo("nl-BE")) : null;
            ...
            var totalSundries = Rounder.RoundDecimal(workTask.WorkEffortInvoiceItemAssignmentsWhereAssignment
            ...
            if (totalSundries > 0)
            {
                this.TotalSundries = totalSundries.ToString("N2", new CultureInfo("nl-BE"));
            }

            var totalCleaning = Rounder.RoundDecimal(workTask.WorkEffortInvoiceItemAssignmentsWhereAssignment
                .Where(v => v.ExistWorkEffortInvoiceItem
            ...
            if (totalCleaning > 0)
            {
                this.TotalCleaning = totalCleaning.ToString("N2", new CultureInfo("nl-BE"));
            }
            ...
            this.HasSublet = workTask.TotalSubContractedRevenue > 0;
        }
        ...
        public string FixedPrice { get; }

        public string TotalLabour { get; }

        public string TotalParts { get; }

        public string TotalSundries { get; }

        public string TotalCleaning{ get; }
