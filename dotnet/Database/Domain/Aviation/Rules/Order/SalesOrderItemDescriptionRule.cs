// <copyright file="SalesOrderItemDescriptionDerivation.cs" company="Allors bvba">
...
{
    public class SalesOrderItemDescriptionRule : Rule
    {
        public SalesOrderItemDescriptionRule(MetaPopulation m) : base(m, new Guid("242e80ee-2b8d-455e-95ef-ddde5e04709e")) =>
