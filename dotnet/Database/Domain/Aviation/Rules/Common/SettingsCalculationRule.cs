// <copyright file="SettingsCalculationRule.cs" company="Allors bvba">
...
{
    public class SettingsCalculationRule : Rule
    {
        public SettingsCalculationRule(MetaPopulation m) : base(m, new Guid("1898a161-6c73-4e57-849f-6933e2d64da3")) =>
            this.Patterns = new Pattern[]
            {
                m.Settings.RolePattern(v => v.CleaningCalculation),
                m.Settings.RolePattern(v => v.SundriesCalculation),
            };
        ...
        private void DeriveCleaningCalculation(Settings @this, IValidation validation)
        {
        ...
        private void DeriveSundriesCalculation(Settings @this, IValidation validation)
        {
