...
export class AppSorterService implements SorterService {
  ...
  constructor(workspaceService: WorkspaceService) {
    ...
    define(
      ...
      new Sorter({
        from: m.MaintenanceAgreement.FromDate,
        through: m.MaintenanceAgreement.ThroughDate,
        customer: m.MaintenanceAgreement.CustomerName,
        type: m.MaintenanceAgreement.WorkEffortTypeDisplayName,
      })
    );
    ...
    define(
      ...
      new Sorter({
        ...
        name: [m.SerialisedItem.PartName],
    ...
    define(
      m.Vehicle,
      new Sorter({
        licensePlateNumber: [m.Vehicle.LicensePlateNumber],
        make: [m.Vehicle.Make],
        model: [m.Vehicle.Model],
        ownedBy: [m.Vehicle.OwnedByPartyName],
      })
    );
    ...
    define(
      m.WorkEffortType,
      new Sorter({
        name: m.WorkEffortType.Name,
        product: m.WorkEffortType.UnifiedGoodDisplayName,
        category: m.WorkEffortType.ProductCategoryDisplayName,
      })
    );
